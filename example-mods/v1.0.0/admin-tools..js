...
//
// Commands:
//   /heal_me              - Restore your health to full
//   /heal <player> <amt>  - Heal a specific player by amount
//   /tp_me <x> <y> <z>    - Teleport yourself to coordinates
//   /gm <mode>            - Change your gamemode
//   /kit                  - Get a basic starter kit
//
// This mod showcases:
...
api.registerMod("admin_tools", {
    onInitialize(api) {
        ...
        api.registerCommand("gm", (ctx, args) => {
            ...
            if (args.length < 1) {
                ctx.reply("Usage: /gm <survival|creative|adventure|spectator>");
                return;
            }
